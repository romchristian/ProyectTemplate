 ...
 */
@Entity
public class Ubicacion implements Serializable, IAuditable {
    ...
    @Listado(descripcion = "Depósito", mostrar = true, entidad = true, campo = "deposito", campoDescripcion = "nombre", modulo = "stock")
